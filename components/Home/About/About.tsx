...
const About = () => {
  return (
    <section id="about" className="pt-16 pb-16 text-white">
      <div className="mx-auto w-full max-w-7xl px-6">
        <div data-aos="fade-down" className="mb-8 text-center">
          ...
          <p className="text-4xl font-semibold tracking-tight text-slate-400 sm:text-6xl">About <span className="text-cyan-200">Me</span></p>
        </div>

        <div className="grid gap-8 lg:grid-cols-[1.5fr_1fr] lg:gap-12">
          {/* Left - About Text */}
          <div data-aos="fade-up" data-aos-delay="120" className="flex flex-col justify-start">
            <div className="rounded-2xl border border-white/10 bg-[#14134145] p-8">
              <p className="text-base leading-8 text-slate-300 sm:text-lg mb-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    <p className="text-lg font-semibold text-white">National Institute Of Technology(NIT) Delhi</p>
                    <span className="text-xs font-medium text-cyan-300 bg-cyan-400/20 px-3 py-1 rounded-full whitespace-nowrap ml-2">2023-2027</span>
                  </div>
                ...
                {codingProfiles.map((profile) => {
                  ...
                  return (
                    <Link
                      ...
                      className="group inline-flex items-center gap-2 rounded-lg border border-cyan-400/50 px-4 py-2 text-sm font-medium text-cyan-200 transition-all hover:-translate-y-0.5 hover:border-cyan-400 hover:bg-cyan-400/10"
                    >
